/**********************************************
 * Author: 3REKSE, EMA3NTO, CCRAZY_IT, IL_NAVY,
 *
 * Visual Laser 10 New
 * Benchmark tools
 **********************************************/
...
int main()
{
	...
	system(CLS);
	cout << "Visual Laser 10 New\n3REKSE, EMA3NTO, CCRAZY_IT, IL_NAVY\n" << endl;
	...
	do
	{
		...
		case '5':
			...
			if (choice == '5')
				break;
		case '6':
			//bm.writeFile(bm.calc(maxSum6), "S6", filetoSave);
			cout << "L'algoritmo S6 non funziona" << endl;
			break;
		default:
